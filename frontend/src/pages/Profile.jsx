                  ...
                  {editingField === "full_name" ? (
                    <div className="flex gap-1">
                      <input
                        ...
                        autoFocus
                      />
                      <button onClick={() => saveEdit("full_name")} className="text-green-400 text-sm">✓</button>
                    </div>
                  ) : (
                    <h2
                  ...
                  {editingField === "date_of_birth" ? (
                    <div className="flex gap-1">
                      <input
                        ...
                        autoFocus
                      />
                      <button onClick={() => saveEdit("date_of_birth")} className="text-green-400 text-sm">✓</button>
                    </div>
                  ) : (
                    <p
    onClick={() => startEdit("date_of_birth", user.date_of_birth)}
  ...
  >
    ...
    <div className="flex gap-2">
      ...
      <label className="text-sm text-slate-400 file:mr-3 file:py-1.5 file:px-3 file:rounded-lg file:border-0 file:text-xs file:font-medium file:bg-slate-700 file:text-white hover:file:bg-slate-600 file:cursor-pointer cursor-pointer transition">
        ...
        />
        {newPostDocument ? newPostDocument.name : "📄 Add Document"}
      </label>
    </div>
    <button
      type="submit"
    ...
    >
      {posting ? "Posting..." : "Post"}
              ...
              {/* Posts Feed */}
              {posts.length === 0 && (
                <p className="text-slate-500 text-center py-8">No posts yet. Share something!</p>
              )}
              ...
              {posts.map((post) => (
                ...
                >
                  ...
                  {post.description && (
                    <p className="text-slate-200 text-sm mb-3">{post.description}</p>
                  )}
                  ...
                  <div className="flex gap-4 pt-2 border-t border-slate-700/50">
                    ...
                    >
                      👎 Dislike {post.dislike_count > 0 && `(${post.dislike_count})`}
                    </button>
                  </div>
                </div>
              ))}
