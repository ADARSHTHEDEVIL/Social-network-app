...
function Profile() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 px-4 py-8">
      ...
      {showShareMenu && (
        <div className="absolute right-0 mt-2 w-80 bg-slate-800 border border-slate-700 rounded-xl shadow-xl z-10 p-6">
          <div className="grid grid-cols-4 gap-x-6 gap-y-6 justify-items-center">
            <button onClick={() => shareToPlatform("whatsapp")} title="WhatsApp" className="w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center hover:opacity-80 transition">
           ...
           <button onClick={() => shareToPlatform("twitter")} title="X (Twitter)" className="w-14 h-14 rounded-full bg-black flex items-center justify-center hover:opacity-80 transition">
            ...
            <button onClick={() => shareToPlatform("copy")} title="Copy Link" className="w-14 h-14 rounded-full bg-indigo-600 flex items-center justify-center hover:opacity-80 transition">
              <svg viewBox="0 0 24 24" className="w-6 h-6 fill-none stroke-white" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m13.35-.622l1.757-1.757a4.5 4.5 0 00-6.364-6.364l-4.5 4.5a4.5 4.5 0 001.242 7.244" /></svg>
            </button>
          </div>
